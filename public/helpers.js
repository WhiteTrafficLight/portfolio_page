...
export function musicBall(obj, camera, renderer, raycaster, current_Audio, tempo, chill_or_dance, song_on) {
    renderer.domElement.addEventListener('mousedown', async (event) => {
        ...
        if (intersects.length > 0 && intersects[0].object instanceof THREE.Mesh) {
            const song = intersects[0].object.geometry.getAttribute('song').array;
