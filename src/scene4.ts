...
export async function initializeScene4(camera: THREE.PerspectiveCamera,renderer:THREE.WebGL1Renderer) {
    ...
    const loadCarModel = (carFramePath: string, carGlassPath: string) => {
