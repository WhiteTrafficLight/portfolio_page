...
async function main() {
    ...
    let hat_1: THREE.Mesh;
    let hat_2: THREE.Mesh;
    let hat_3: THREE.Mesh;
    ...
    function musicBall(obj: THREE.Object3D, camera : THREE.PerspectiveCamera) {
    ...
    let mat1 = store1.material as THREE.MeshPhongMaterial;
    ...
    let mat2 = store2.material as THREE.MeshPhongMaterial;
    ...
    let mat3 = store3.material as THREE.MeshPhongMaterial;
    ...
    const animate = () => {
        ...
        if(scene_nr == 1){
            ...
            if (current_Audio&&song_on) {
                ...
                scene.traverse(function(obj){
                    if(obj.name == "ball" && obj instanceof THREE.Mesh){
                        let material = obj.material as THREE.MeshPhongMaterial
            ...
            for (let i = 0; i < 10000; i++) {
                ...
                if (snowGeometry.attributes.position.getY(i) < -1) snowGeometry.attributes.position.setY(i, Math.random() * 2000)
            }
            ...
            renderer.render(scene, camera);
                ...
                for (let i = 0; i < 1000; i++) {
                    ...
                    if (snowGeometry2.attributes.position.getZ(i) < -101) snowGeometry2.attributes.position.setZ(i, Math.random() * 200)
                }
                ...
                for (let i = 0; i < 1000; i++) {
                    ...
                    if (snowGeometry3.attributes.position.getZ(i) < -101) snowGeometry3.attributes.position.setZ(i, Math.random() * 200)
                }
